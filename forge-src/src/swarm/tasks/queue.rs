...
impl TaskQueue {
    ...
    pub fn new(swarm_root: &Path) -> Self {
        Self {
    ...
    pub fn initialize(&self) -> ForgeResult<()> {
        let tasks_dir = self.swarm_root.join("tasks");
    ...
    /// Create a new task
    pub fn create_task(&self, task: Task) -> ForgeResult<()> {
    ...
    pub fn load_task(&self, task_id: &str) -> ForgeResult<Option<Task>> {
    ...
    /// Load all tasks
    pub fn load_all_tasks(&self) -> ForgeResult<Vec<Task>> {
    ...
    pub fn load_tasks_by_status(&self, status: &TaskStatus) -> ForgeResult<Vec<Task>> {
        let mut tasks = Vec::new();
        let dir = self.status_dir(status);
    ...
    pub fn load_tasks_for_agent(&self, agent_id: &str) -> ForgeResult<Vec<Task>> {
    ...
    pub fn get_completed_task_ids(&self) -> ForgeResult<HashSet<String>> {
    ...
    pub fn find_claimable_tasks(&self, agent_id: &str) -> ForgeResult<Vec<Task>> {
    ...
    pub fn update_task(&self, task: &Task) -> ForgeResult<()> {
    ...
    /// Delete a task
    pub fn delete_task(&self, task_id: &str) -> ForgeResult<bool> {
    ...
    /// Get task statistics
    pub fn get_statistics(&self) -> ForgeResult<TaskStatistics> {
    ...
    pub fn get_agent_assignments(&self) -> ForgeResult<HashMap<String, Vec<Task>>> {
        let tasks = self.load_all_tasks()?;
