...
- [colony init](./cli/init.md)
- [colony start](./cli/start.md)
- [colony status](./cli/status.md)
- [colony agent](./cli/agent.md)
- [colony template](./cli/template.md)
- [colony plugin](./cli/plugin.md)
- [colony workflow](./cli/workflow.md)
